...
| D-33 | The original apparition wakes a standing actor tile and XOR flashes the viewport for every live slot; native has no such renderer path | queued visual gap | OUTSUBS 0x0850-0x08c1 and native event/renderer comparison; separate from H-175 mutation/acknowledgement parity | H-176 |
